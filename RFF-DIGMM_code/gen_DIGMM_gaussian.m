function [Zx, Zt, trtime] = gen_DIGMM_gaussian(X_train, X_test, sigmafir, sigmasec, mapdim)
    ...
    for iit = 1:sto_times
        ...
        for i = 1:Nsample
            for j = 1:Nsample
                ...
                ktrain(i,j) = exp(norm(TrainX(i,:)-TrainX(j,:)).^2/(2*sigmafir^2))-exp(norm(TrainX(i,:)-TrainX(j,:)).^2/(2*sigmasec^2));
            end
        end
